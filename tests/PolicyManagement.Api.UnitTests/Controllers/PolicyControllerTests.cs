...
public class PolicyControllerTests
{
    ...
    [Fact]
    public async Task GetAllPoliciesAcrossTenants_ReturnsOkObjectResult_WithPolicies()
    {
        // Arrange
        var pageNumber = 1;
        var pageSize = 10;
        ...
        // Act
        var result = await _controller.GetAllPoliciesAcrossTenants(pageNumber, pageSize);
    ...
    [Fact]
    public async Task GetUserPolicies_WithValidUserId_ReturnsOkObjectResult()
    {
        // Arrange
        var userId = 1;
        var pageNumber = 1;
        ...
        var policyResponseDto = new PolicyResponseDto
        {
            Policies = new List<PolicyDto>
            {
                new PolicyDto { Id = 1, Name = "User Policy 1" },
                new PolicyDto { Id = 2, Name = "User Policy 2" }
            },
            TotalCount = 2,
            PageNumber = pageNumber,
            PageSize = pageSize
        ...
        // Act
        var result = await _controller.GetUserPolicies(pageNumber, pageSize);
