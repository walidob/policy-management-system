...
- Create Angular project with ng: `ng new policymanagementapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`policymanagementapp.client.esproj`).
