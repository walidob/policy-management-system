...
public class TenantDataSeeder
{
    ...
    public async Task SeedAllTenantsAsync()
    {
        ...
        foreach (var tenant in tenants)
        {
            ...
            try
            {
                ...
                await GenerateRandomDataAsync(context);
    ...
    private async Task GenerateRandomDataAsync(TenantDbContextBase context)
    {
        ...
        for (int i = 0; i < 15; i++)  
        {
            ...
            {
                Name = $"Sample Policy {i + 1}",
                Description = $"This is a sample policy description for policy {i + 1}",
