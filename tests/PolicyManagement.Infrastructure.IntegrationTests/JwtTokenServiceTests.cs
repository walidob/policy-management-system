...
public class JwtTokenServiceTests
{
    ...
    public void GenerateToken_ShouldReturnValidJwtToken()
    {
        ...
        var roles = new List<string> { "TenantAdmin", "TenantUser" };
        ...
        // Verify roles
        jwtToken.Claims.Should().Contain(c => c.Type == ClaimTypes.Role && c.Value == "TenantAdmin");
        jwtToken.Claims.Should().Contain(c => c.Type == ClaimTypes.Role && c.Value == "TenantUser");
    }
    ...
    public void GenerateToken_WithNullTenantId_ShouldIncludeEmptyTenantIdClaim()
    {
        ...
        jwtToken.Claims.Should().Contain(c => c.Type == ClaimTypes.Role && c.Value == "SuperAdmin");
    }
} 