...
{
    [Fact]
    public void GetPolicies_HasResponseCacheAttribute_WithCorrectParameters()
    {
        // Arrange
        var methodInfo = typeof(PolicyController).GetMethod(nameof(PolicyController.GetPolicies));
    ...
    [Fact]
    public void GetPolicy_HasResponseCacheAttribute_WithCorrectParameters()
    {
        // Arrange
        var methodInfo = typeof(PolicyController).GetMethod(nameof(PolicyController.GetPolicy));
