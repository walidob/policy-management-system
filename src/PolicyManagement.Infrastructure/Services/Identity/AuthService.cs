        ...
        public async Task<AuthenticationResponse> AuthenticateAsync(AuthenticationRequest request)
        {
            try
            {
                ...
                if (user == null)
                {
                    ...
                    throw new InvalidOperationException($"User not found - username {request.Username} not found.");
                }
                ...
                if (!result.Succeeded)
                {
                    ...
                    throw new InvalidOperationException($"Invalid credentials - user {request.Username}.");
                }
